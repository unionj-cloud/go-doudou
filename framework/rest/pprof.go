...
// Package rest serves via its HTTP server runtime profiling data
...
func init() {
	http.HandleFunc(config.GddConfig.RouteRootPath+"/debug/pprof/", Index)
	http.HandleFunc(config.GddConfig.RouteRootPath+"/debug/pprof/cmdline", Cmdline)
	http.HandleFunc(config.GddConfig.RouteRootPath+"/debug/pprof/profile", Profile)
	http.HandleFunc(config.GddConfig.RouteRootPath+"/debug/pprof/symbol", Symbol)
	http.HandleFunc(config.GddConfig.RouteRootPath+"/debug/pprof/trace", Trace)
}
...
// For example, config.GddConfig.RouteRootPath + "/debug/pprof/heap" serves the "heap" profile.
// Index responds to a request for config.GddConfig.RouteRootPath + "/debug/pprof/" with an HTML page
// listing the available profiles.
func Index(w http.ResponseWriter, r *http.Request) {
	if name, found := strings.CutPrefix(r.URL.Path, config.GddConfig.RouteRootPath+"/debug/pprof/"); found {
		if name != "" {
