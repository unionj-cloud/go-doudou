// For more information please see https://github.com/antlr/grammars-v4/tree/master/sql/mysql/Positive-Technologies
...
createDatabaseOption
    : defaultToken=DEFAULT? (CHARACTER SET | CHARSET) '='? (charsetName | charsetDefault=DEFAULT)
    | defaultToken=DEFAULT? COLLATE '='? collationName
    ;
...
dataType
    : typeName=(
      ...
      VARYING?
      lengthOneDimension? binaryType=BINARY?
      ((CHARACTER SET | CHARSET) charsetName)?
    ...
    | typeName=(ENUM | SET)
      ...
      ((CHARACTER cs=SET | CHARSET) charsetName)?                      #collectionDataType
    | typeName=(
